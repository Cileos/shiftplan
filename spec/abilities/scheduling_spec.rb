  ...
  context "As an owner" do
    ...
    context "for other organizations" do
      it "should not be able to read schedulings" do
        should_not be_able_to(:read, create(:scheduling, plan: another_plan))
      end

      it "should not be able to update schedulings" do
        should_not be_able_to(:update, create(:scheduling, plan: another_plan))
      end

      it "should not be able to create schedulings" do
        should_not be_able_to(:create, build(:scheduling, plan: another_plan))
      end

      it "should not be able to destroy schedulings" do
        should_not be_able_to(:destroy, create(:scheduling, plan: another_plan))
      end
    end
  end
