Feature: As a logged in user
  ...
  Scenario: Changing the email address
    ...
    When I choose "Einstellungen" from the drop down "Marge Bouvier"
     ...
     Then I should be on the edit page of the confirmed user
      And I should see "Bitte schauen Sie in Ihr E-Mail Postfach"
     ...
     Then I should be on the change email confirmation page
      And I should see "Um die Änderung Ihrer E-Mail Adresse in marge@thesimpsons.com zu bestätigen, geben Sie bitte Ihr Passwort ein."
