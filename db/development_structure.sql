...
CREATE TABLE "default_availabilities" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "employee_id" integer, "day_of_week" integer(1), "start" time, "end" time, "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "plans" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "account_id" integer, "name" varchar(255), "start" datetime, "end" datetime, "duration" integer, "created_at" datetime, "updated_at" datetime);
