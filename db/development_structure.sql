...
CREATE TABLE "employees" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "first_name" varchar(255), "last_name" varchar(255), "birthday" date, "email" varchar(255), "phone" varchar(255), "street" varchar(255), "zipcode" varchar(255), "city" varchar(255), "created_at" datetime, "updated_at" datetime);
