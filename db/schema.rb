...
ActiveRecord::Schema.define(:version => 20130129124455) do
  ...
  create_table "shifts", :force => true do |t|
    ...
    t.datetime "updated_at",        :null => false
    t.integer  "day"
    t.integer  "overnight_mate_id"
  end

  add_index "shifts", ["overnight_mate_id"], :name => "index_shifts_on_overnight_mate_id"
